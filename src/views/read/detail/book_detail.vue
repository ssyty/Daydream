<template>
    <div class="book_detail">
        <top :title="title" :src="require(`../../../../public/images/${num}.jpg`)" :isload="!show"></top>
        ...
        <transition enter-active-class="fadeIn" leave-active-class="fadeOutLeft">
            <main class="animated" v-if="show" @scroll="scrH">
                ...
                <div class="bottom">
                    ...
                    <router-link to="/text/0" class="bottom_link" id="bottom_link">
...
<script>
    ...
    export default {
        ...
        created() {
            this.num = parseInt(Math.random() * 4 + 1)
